...
def send_gather_tasks():
    ...
    tasks = [{
        ...
        "hashtags": ["fitness", "travel", "homeworkouts", "codinglife", "morningroutine"],
        "keywords": ["how to get abs", "web development", "gym motivation", "interior design tips", "morning habits"],
        "sources": ["tiktok"]
    }]
    for project_info in all_projects:
        ...
        if project_ht_list or project_keywords_list:
            tasks.append({
